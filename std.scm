...
(define (foldr f end lst) (if (null? lst) end (f (car lst) (foldr f end (cdr lst)))))
(define (foldl f accum lst) (if (null? lst) accum (foldl f (f accum (car lst)) (cdr lst))))
(define fold foldl)
(define reduce foldr)
(define (unfold f init pred) (if (pred init) (cons init '()) (cons init (unfold func (func init) pred))))
